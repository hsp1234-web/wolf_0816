...
log = logging.getLogger('UV_Opt_TestRunner')

class TestRunner:
    """
    (UV 優化測試版本)
    此版本使用 'uv' 來安裝 Python 依賴，以測試其對啟動時間的優化效果。
    """
    def __init__(self):
        self.processes = []
        self.api_port = None
    ...
    def run(self):
        ...
        try:
            steps = [
                ("安裝依賴 (uv)", self._install_dependencies),
